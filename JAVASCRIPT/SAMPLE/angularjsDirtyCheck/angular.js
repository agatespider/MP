  ...
  it('should make JSONP request to invalid URL and invoke the error handler',
    ...
    function sendReq(config, reqData, reqHeaders) {
      ...
      function done(status, response, headersString, statusText) {
        ...
        if (!$rootScope.$$phase) {console.log('WHAT?');$rootScope.$apply();}
      }
  ...
  this.$get = ['$rootScope', '$window', '$q',
    ...
    function interval(fn, delay, count, invokeApply) {
      ...
      promise.$$intervalId = setInterval(function tick() {
        ...
        if (!skipApply) {console.log('interval'); $rootScope.$apply();}
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    console.log('z4')
      ...
      $digest: function() {
        ...
        do { // "while dirty" loop
            console.log("DIRTY DIRTY ICE ICE");
          dirty = false;
          current = target;
  ...
  this.$get = ['$rootScope', '$browser', '$q', '$exceptionHandler',
    ...
    function timeout(fn, delay, invokeApply) {
      ...
      timeoutId = $browser.defer(function() {
        ...
        if (!skipApply) { console.log('Time out'); $rootScope.$apply(); }
      }, delay);
    ...
    link: function(scope, element, attr, ctrls) {
      ...
      function setupAsSingle(scope, selectElement, ngModelCtrl, selectCtrl) {
        ...
        selectElement.on('change', function() {
            console.log('Sing SelectElement Change');
          scope.$apply(function() {
            if (unknownOption.parent()) unknownOption.remove();
      ...
      function setupAsOptions(scope, selectElement, ctrl) {
        ...
        selectElement.on('change', function() {
            console.log('Setup as  SelectElement Change');
          scope.$apply(function() {
            var optionGroup,
